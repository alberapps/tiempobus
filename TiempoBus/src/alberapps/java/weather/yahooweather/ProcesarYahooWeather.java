...
public class ProcesarYahooWeather {
     ...
     * @throws Exception
     */
    public static WeatherQuery getDatosClima(String lat, String lon, Localizacion localizacion) throws Exception {
        ...
        try {
            ...
            */
            ...
            if (localizacion != null && localizacion.getLocalidad() != null && !localizacion.getLocalidad().equals("")) {
                textLocalizacion = localizacion.getLocalidad() + ", es";
            } else {
                textLocalizacion = "alicante, es";
            }

            String query = "select * from weather.forecast where woeid in (select woeid from geo.places(1) where text='" + textLocalizacion + "') and u = 'c'";
