...
package alberapps.android.tiempobus.infolineas.galeriaImagenes.displayingbitmaps.util;
...
public abstract class ImageWorker {
    ...
    public void loadImage(Object data, ImageView imageView, OnImageLoadedListener listener) {
        ...
        if (value != null) {
            ...
            int dId = Integer.parseInt((String)data);

            imageView.setImageDrawable(ResourcesCompat.getDrawable(mResources, dId, null));
