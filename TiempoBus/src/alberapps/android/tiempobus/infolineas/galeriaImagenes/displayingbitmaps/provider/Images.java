...
package alberapps.android.tiempobus.infolineas.galeriaImagenes.displayingbitmaps.provider;
...
public class Images {
    ...
    public final static String[] imageUrls = new String[] {
            Integer.toString(R.drawable.planozonal),
            Integer.toString(R.drawable.tram_l2),
            Integer.toString(R.drawable.obras_l9)
    };
    /*public final static String[] imageUrls = new String[] {
